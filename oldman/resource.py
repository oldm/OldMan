...
class Resource(object):
    ...
    that are treated as blank nodes when the resource is serialized in JSON, JSON-LD
    or into another RDF format (for external consumption).
    ...
    :func:`oldman.management.manager.ResourceManager.find_models_and_types`.
    ...
    .. admonition:: Resource creation
        ...
        :func:`oldman.management.manager.ResourceManager.create` or
        :func:`oldman.management.manager.ResourceManager.new`  for creating new
        :class:`~oldman.resource.Resource` objects.

    :param manager: :class:`~oldman.management.manager.ResourceManager` object. Gives
    ...
    :param base_iri: Base IRI that is given to the main model for generating a new IRI if no `id` is given.
                     The IRI generator may ignore it. Defaults to `None`.
    ...
    def in_same_document(self, other_resource):
        """Tests if two resources have the same base IRI.

        :return: `True` if these resources are in the same document.
        """
        return self.base_iri == other_resource.base_iri
    ...
    def full_update_from_graph(self, subgraph, initial=False, is_end_user=True, allow_new_type=False,
