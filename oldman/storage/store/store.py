...
from oldman.storage.store.cache import ResourceCache
from oldman.core.exception import UnsupportedDataStorageFeatureException, OMAttributeAccessError, OMUniquenessError
from oldman.core.exception import OMObjectNotFoundError, OMClassInstanceError
...
"""
    ...
    def create_model(self, class_name_or_iri, context, iri_generator=None, iri_prefix=None,
        ...
        self._model_manager.create_model(class_name_or_iri, context, self, self._schema_graph,
