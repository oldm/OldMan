...
class ResourceManager(object):
    ...
    def filter(self, types=None, base_iri=None, limit=None, eager=False, **kwargs):
        """See :func:`oldman.management.finder.ResourceFinder.filter`."""
        return self._finder.filter(types=types, base_iri=base_iri, limit=limit, eager=eager, **kwargs)
